...
//
//class BeerResourceIntegrationTest extends BaseIntegrationTest {
//
//    @Autowired
...
//                .andExpect(jsonPath("$.brewery").value(expected.brewery()));
//    }
//
//    @Test
...
//                .andExpect(jsonPath("$.brewery").value(beerResponse().brewery()));
//    }
//}
